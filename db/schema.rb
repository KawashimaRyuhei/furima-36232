...
ActiveRecord::Schema.define(version: 2021_08_06_125200) do
  ...
  create_table "transmits", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["buy_id"], name: "index_transmits_on_buy_id"
  end
  ...
  add_foreign_key "transmits", "buys"
end
