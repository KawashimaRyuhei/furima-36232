class User < ApplicationRecord
  ...
  with_options presence: true do
    validates :nickname
    validates :encrypted_password,:password,:password_confirmation,length:{minimum:6},format:{with: /(?=.*[a-zA-Z])(?=.*\d)[a-zA-Z\d]{6,}/, message: "Please include both letters and numbers in your settings"}
